package vben.common.mail.utils;
...
public class MailUtils {
    ...
    public static MailAccount getMailAccount(String from, String user, String pass) {
        ACCOUNT.setFrom(StrUtils.blankToDefault(from, ACCOUNT.getFrom()));
        ACCOUNT.setUser(StrUtils.blankToDefault(user, ACCOUNT.getUser()));
        ACCOUNT.setPass(StrUtils.blankToDefault(pass, ACCOUNT.getPass()));
        return ACCOUNT;
    }
    ...
    private static List<String> splitAddress(String addresses) {
        if (StrUtils.isBlank(addresses)) {
            return null;
        }

        List<String> result;
        if (StrUtils.contains(addresses, CharUtil.COMMA)) {
            result = StrUtils.splitTrim(addresses, CharUtil.COMMA);
        } else if (StrUtils.contains(addresses, ';')) {
            result = StrUtils.splitTrim(addresses, ';');
        } else {
