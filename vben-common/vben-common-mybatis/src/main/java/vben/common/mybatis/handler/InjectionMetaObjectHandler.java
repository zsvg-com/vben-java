...
import vben.common.mybatis.core.domain.BaseEntity;
...
public class InjectionMetaObjectHandler implements MetaObjectHandler {
    ...
    public void insertFill(MetaObject metaObject) {
        try {
            if (ObjectUtils.isNotNull(metaObject) && metaObject.getOriginalObject() instanceof BaseEntity baseEntity) {
                ...
                if (ObjectUtils.isNull(baseEntity.getCreateBy())) {
