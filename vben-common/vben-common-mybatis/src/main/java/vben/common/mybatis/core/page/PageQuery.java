package vben.common.mybatis.core.page;
...
import vben.common.core.utils.sql.SqlUtil;
...
public class PageQuery implements Serializable {
    ...
    private List<OrderItem> buildOrderItem() {
        if (StrUtils.isBlank(orderByColumn) || StrUtils.isBlank(isAsc)) {
            return null;
        }
        String orderBy = SqlUtil.escapeOrderBySql(orderByColumn);
        orderBy = StrUtils.toUnderlineCase(orderBy);

        // 兼容前端排序类型
        isAsc = StrUtils.replaceEach(isAsc, new String[]{"ascending", "descending"}, new String[]{"asc", "desc"});
