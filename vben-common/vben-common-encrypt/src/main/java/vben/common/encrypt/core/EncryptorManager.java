package vben.common.encrypt.core;
...
public class EncryptorManager {
    ...
    public String encrypt(String value, EncryptContext encryptContext) {
        if (StrUtils.startWith(value, Constants.ENCRYPT_HEADER)) {
            return value;
        }
    ...
    public String decrypt(String value, EncryptContext encryptContext) {
        ...
        IEncryptor encryptor = this.registAndGetEncryptor(encryptContext);
        String str = StrUtils.removePrefix(value, Constants.ENCRYPT_HEADER);
    ...
    private void scanEncryptClasses(String typeAliasesPackage) {
        ...
        String[] packagePatternArray = StrUtils.splitPreserveAllTokens(typeAliasesPackage, ConfigurableApplicationContext.CONFIG_LOCATION_DELIMITERS);
