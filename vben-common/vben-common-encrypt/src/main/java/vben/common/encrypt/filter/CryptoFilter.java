package vben.common.encrypt.filter;
...
import vben.common.core.constant.HttpStatus;
...
import vben.common.encrypt.annotation.ApiEncrypt;
import vben.common.encrypt.properties.ApiDecryptProperties;
...
public class CryptoFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (HttpMethod.PUT.matches(servletRequest.getMethod()) || HttpMethod.POST.matches(servletRequest.getMethod())) {
            ...
            if (StrUtils.isNotBlank(headerValue)) {
                ...
                // 是否有注解，有就报错，没有放行
                if (ObjectUtils.isNotNull(apiEncrypt)) {
    ...
    private ApiEncrypt getApiEncryptAnnotation(HttpServletRequest servletRequest) {
        ...
        try {
            ...
            if (ObjectUtils.isNotNull(mappingHandler)) {
