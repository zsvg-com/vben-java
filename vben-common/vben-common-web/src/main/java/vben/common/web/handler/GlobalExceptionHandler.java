package vben.common.web.handler;
...
import vben.common.core.exception.SseException;
...
public class GlobalExceptionHandler {
    ...
    public R<Void> handleServiceException(ServiceException e, HttpServletRequest request) {
        ...
        return ObjectUtils.isNotNull(code) ? R.fail(code, e.getMessage()) : R.fail(e.getMessage());
    }
