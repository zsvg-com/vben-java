package vben.mybatis.demo.ruoyi;
...
import vben.common.mybatis.core.page.PageQuery;
import vben.common.mybatis.core.page.TableDataInfo;
...
public class TestDemoServiceImpl implements ITestDemoService {
    ...
    private LambdaQueryWrapper<TestDemo> buildQueryWrapper(TestDemoBo bo) {
        ...
        lqw.like(StrUtils.isNotBlank(bo.getTestKey()), TestDemo::getTestKey, bo.getTestKey());
        lqw.eq(StrUtils.isNotBlank(bo.getValue()), TestDemo::getValue, bo.getValue());
