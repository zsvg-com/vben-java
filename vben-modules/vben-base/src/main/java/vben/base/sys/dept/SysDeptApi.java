...
public class SysDeptApi {
    ...
    public R<List<SysDeptVo>> list(String name) {
    ...
    public R<SysDept> info(@PathVariable String id) {
        SysDept main = service.findById(id);
        return R.ok(main);
    }
    ...
    public R<String> post(@RequestBody SysDept main) {
        service.insert(main);
    ...
    @PutMapping
    public R<String> put(@RequestBody SysDept main) {
        service.update(main);
        return R.ok(null,main.getId());
    }
