...
public class SysOrgReceDao {

    public void saveAll(List<SysOrgRece> list) {
        List<Object[]> deleteList = new ArrayList<>();
        List<Object[]> insertLIst = new ArrayList<>();
        for (SysOrgRece rece : list) {
        ...
        String deleteSql = "delete from sys_org_rece where useid=? and oid=?";
        jdbcHelper.batch(deleteSql, deleteList);
        String insertSql = "insert into sys_org_rece(id,useid,oid,uptim) values(?,?,?,?)";
        jdbcHelper.batch(insertSql, insertLIst);
    }


    public void insert(SysOrgRece rece) {
        Isqler sqler = new Isqler("sys_org_rece");
    ...
    public void deleteById(String id) {
        String sql = "delete from sys_org_rece where id=?";
