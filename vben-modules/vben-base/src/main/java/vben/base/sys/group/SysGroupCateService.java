...
public class SysGroupCateService {
    ...
    public Integer delete(String id) {
        Integer size=1;
        String sql = "select id from sys_group_cate where pid=?";
    ...
    public void move(Smove bo) {
        SysGroupCate dragCate = cateDao.findById(bo.getDraid());
        String sql = "select id,ornum from sys_group_cate where ornum>? and pid=?";
        ...
        String updateSql = "update sys_group_cate set ornum=? where id=?";
        ...
        if ("inner".equals(bo.getType())) {
            ...
            SysGroupCate dropCate = cateDao.findById(bo.getDroid());
            dragCate.setPid(dropCate.getPid());
            dragCate.setOrnum(dropCate.getOrnum());
            String sql3 = "select id,ornum from sys_group_cate where ornum>? and pid=?";
            ...
            String updateSql3 = "update sys_group_cate set ornum=? where id=?";
            ...
            String updateSql4 = "update sys_group_cate set ornum=? where id=?";
    ...
    private final SysGroupCateDao cateDao;
}
